	...
	<div>
		...
		<form action="updateBoard.do" method="post">
			...
			<table>
				...
				<!-- 파일경로추가 -->
				<tr>
					<td width="80px">파일경로</td> 
					<td><%= board.getFileAddress() %></td>
				</tr>
			...
			<br>
			<div style="text-align: center; width: 350px; height: 300px; border: 10px solid darkgray;">
				
				<img alt="" src="${ pageContext.request.contextPath }${ board.fileAddress }" width="100%" height="100%">
				
			</div>
			<p>이미지경로: ${ pageContext.request.contextPath }${ board.fileAddress }</p>
